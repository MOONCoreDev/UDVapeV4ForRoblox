...
local hash = loadstring(downloadFile('newvapeud/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('newvapeud/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('newvapeud/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:hook()
		...
		if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
			if exp and exp:WaitForChild('appLayout', 5) then
				vape:Clean(exp.appLayout.chatWindow.scrollingView.bottomLockedScrollView.RCTScrollView.RCTScrollContentView:FindFirstChild('RCTScrollContentView', true).ChildAdded:Connect(function(obj)
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('newvapeud/profiles/whitelist.json') and readfile('newvapeud/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('newvapeud/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('newvapeud/assets/new/radaricon.png'),
