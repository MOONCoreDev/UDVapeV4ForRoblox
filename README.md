...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/MOONCoreDev/UDVapeV4ForRoblox/main/NewMainScript.lua", true))()
```
...
1. Deleting the newvapeud folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/MOONCoreDev/UDVapeV4ForRoblox/refs/heads/main/NewMainScript.lua)
