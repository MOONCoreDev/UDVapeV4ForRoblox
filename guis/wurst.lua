...
local getcustomassets = {
	['newvapeud/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/MOONCoreDev/UDVapeV4ForRoblox/'..readfile('newvapeud/profiles/commit.txt')..'/'..select(1, path:gsub('newvapeud/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('newvapeud/assets/wurst/triangle.png')
